    ...
    <>
      <div className="h-[90vh] relative bg-white">
        ...
        <h1 className="absolute top-1/3 left-1/2 -ml-20 md:-ml-40 text-7xl md:text-9xl font-black">
          HE<br />LLO<span className="text-red-400">.</span>
        </h1>
      ...
      <AppSection title="Work">
        <p>
          I am a full-stack developer working both as a freelancer,
          and employed at Novicell doing frontend work.
          I have a passion for learning and building awesome digital services/stuff that i want. I love launching new products, from the planning and designing to solving real-life problems with well coded solutions. I have launched several app projects to both Google Play and Apple Appstore. When not coding i enjoy tasting whisky, going on hikes, and reading sci-fi books.
        </p>
      </AppSection>
      ...
      <AppSection title="Bio">
        <div className="grid grid-cols-[1fr,4fr]">
          ...
          <div>2021 - present</div><div>Working at Novicell</div>
        </div>
      </AppSection>
    </>
  )
