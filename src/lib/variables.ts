...
export const GLOBAL = {
  // Site metadata
  username: "nikolajjsj",
  rootUrl: "https://nikolajjsj.com",
  shortDescription: "Nikolaj's personal website",
  longDescription:
    "My personal portfolio and blog, showcasing my web development projects and articles.",

  // Social media links
  githubProfile: "https://github.com/nikolajjsj",
